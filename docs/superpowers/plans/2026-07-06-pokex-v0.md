...
**Goal:** Bot completo de pesca para PokeXGames (pescar → lutar → lootear → capturar), controlado por painel Phoenix LiveView, conforme a spec `docs/superpowers/specs/2026-07-06-pokex-fishing-bot-design.md`.
