defmodule Pokex.Layout do
  ...
  # Without a layout there is no declared option, the same answer `region/2` gives for the
  # rectangle. Raising here crashed the page for whoever reads the screen by hand marks alone,
  # which is his case: there never was a `layout_fix.json`.
