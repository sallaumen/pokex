defmodule Pokex.Screen.BarOffsetTest do
  ...
  # In the black box of 14/09 his `player_point` is (1695, 686), his own name
  # line sits at y 617 — 69 px above it — and the Golem standing one tile below
  # him publishes (1720, 918) while its drawn body is at y ~808. The published
  # point is one tile below the bar by construction (`CrowdScan.place/4`) and the
  # bar floats only 69 px over the creature's foot, so the point lands 110 px
  # UNDER the body.
  describe "the vector from the published point to the body" do
    ...
    # ABOVE the point the eye published — never below it, which is what the #657
    # entry did ("ele jogou pra baixo, tem que ser mais pra cima", Lucas 14/09).
